...
kmeans_model = joblib.load("RealGuitar_clustering.pkl")
tfidf_vectorizer = joblib.load("RealGuitar_tfidf_vectorizer.pkl")

# === Set Halaman ===
st.set_page_config(page_title="Topic Clustering - Real Guitar", layout="wide")

# === Judul Aplikasi dengan Emoji Gitar 🎸 ===
st.title("🎸 Topic Clustering - Real Guitar")
    ...
    if file:
        ...
        if not required_cols.issubset(df.columns):
            ...
            st.download_button(
                ...
                file_name="hasil_klaster_real_guitar.csv",
                mime="text/csv"
            )
